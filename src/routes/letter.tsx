...
export function NextRoom({ to, label }: { to: string; label: string }) {
  return (
    <section className="mx-auto max-w-3xl px-6 pb-8 pt-16 text-center sm:px-10">
      <Link
        to={to}
        className="group inline-flex items-center gap-2 rounded-full bg-foreground px-7 py-3.5 text-sm font-medium text-background shadow-3d transition hover:-translate-y-0.5"
      >
        {label}
