      ...
      <section className="mx-auto max-w-5xl px-5 pb-6 sm:px-10">
        <div className="space-y-6">
          {lessons.map((l, i) => (
            <Tilt3D key={i} max={6}>
              <article
                className={`animate-fade-up grid gap-6 rounded-4xl bg-white/90 p-7 shadow-soft-mint backdrop-blur sm:grid-cols-[auto_1fr] sm:p-10`}
        ...
        <Tilt3D max={9}>
          <div className="relative overflow-hidden rounded-[2.5rem] shadow-3d">
            <img
              ...
              className="h-85 w-full object-cover sm:h-140"
            />
